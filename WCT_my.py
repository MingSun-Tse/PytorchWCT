...
# Data loading code
dataset = Dataset(args.contentPath, args.stylePath, args.fineSize, args.picked_content_mark, args.picked_style_mark)
...
for i, (contentImg, styleImg, imname) in enumerate(loader):
    ...
    cImg = contentImg # Variable(contentImg, volatile=True)
    sImg = styleImg # Variable(styleImg, volatile=True)
