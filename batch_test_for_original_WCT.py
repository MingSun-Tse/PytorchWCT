...
for i,j in pairs:
  script = "python WCT_my.py --cuda  --UHD --UHD_contentPath images/UHD_content/center_img/ --fineSize=3000 --log_mark=20181114-1016  --picked_content_mark=%s  --picked_style_mark=%s" % (i, j)
  os.system(script)
